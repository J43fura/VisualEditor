 ...
 */
ve.demo.SurfaceContainer = function VeDemoSurfaceContainer(
  target,
  page,
  lang,
  dir
  ...
  this.$element
    .addClass("ve-demo-surfaceContainer")
    .append(
      $("<div>")
        .addClass("ve-demo-toolbar ve-demo-surfaceToolbar-edit")
        .append(
          $("<div>")
            .addClass("ve-demo-toolbar-commands")
            .append(
              pageLabel.$element,
      ...
      $("<div>")
        .addClass("ve-demo-toolbar-commands ve-demo-surfaceToolbar-read")
        .append($exitReadButton),
...
ve.demo.SurfaceContainer.prototype.change = function (mode, page) {
  ...
  return closePromise.done(function () {
    var isRead = mode === "read",
      ...
      $editStylesheets = $(
        "link[rel~=stylesheet]:not(.stylesheet-read):not(.stylesheet-" +
          otherDir +
          ")"
      );
    ...
    container.$element
      .find(".ve-demo-surfaceToolbar-edit")
      .toggleClass("oo-ui-element-hidden", isRead);
    container.$element
      .find(".ve-demo-surfaceToolbar-read")
      .toggleClass("oo-ui-element-hidden", !isRead);
...
ve.demo.SurfaceContainer.prototype.destroy = function () {
  ...
  ve.demo.surfaceContainers.splice(
    ve.demo.surfaceContainers.indexOf(container),
    1
  );
